...
; Monero GUI wallet
Source: "bin\pulse-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
...
; Filename: "{app}\pulse-wallet-gui.exe"; Description: "Run GUI Wallet now"; Flags: postinstall nowait skipifsilent
...
Name: "{group}\GUI Wallet"; Filename: "{app}\pulse-wallet-gui.exe"
